  ...
  return (
    <section className="w-full h-[calc(100vh-60px)] bg-black relative">
      <div className="h-5/6 w-full flex items-center justify-center flex-col">
        <p id="hero" className="text-center font-semibold text-3xl text-gray-100 opacity-0 mb-10 md:mb-0">iPhone 15 Pro</p>
      ...
      <div
        id="cta"
        className="flex flex-col items-center opacity-0 transform-gpu translate-y-20"
      >
